                                ...
                                <div class="card" style="border: 3px solid; background-color:rgb(190, 240, 255)">
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="d-flex gap-2 py-3" style="border-bottom: 1px solid;">
                                            ...
                                            <div class="jadwal">
                                                <p class="fs-6 m-0">Pertemuan Hari {{ $ekskul->ekskulkedua->hari }} {{$item->tanggal}}</p>
                                                <p class="m-0">{{ $ekskul->ekskulkedua->jam }}</p>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="d-flex flex-column gap-2 mb-3">
                                                <div class="button-absen">
                                                    <form action="{{ route('absensi', $ekskul->ekskul2) }}" method="post">
                                                        @csrf
                            ...
                            <div class="modal fade " id="modal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('izin', $ekskul->ekskul2)}}" method="post">
                                            @csrf
