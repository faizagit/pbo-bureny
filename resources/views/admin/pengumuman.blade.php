                ...
                <div class="col">
                    <div class="card p-5">
                        <div class="ekskul row">
                            <div class="col-12">
                                <a class="text-light" href="{{ route('index_pengumuman', $ekskul->ekskul1) }}">
                            ...
                            <div class="col-12">
                                <a class="text-light" href="{{ route('index_pengumuman', $ekskul->ekskul2) }}">
                                    <div class="card card-ekskul" style="border: 1px solid black">
                                        <div class="card-body" id="card-ekskul">
                            ...
                            <div class="col-12">
                                <a class="text-light" href="{{ route('index_pengumuman', $ekskul->ekskul3) }}">
                                    <div class="card card-ekskul" style="border: 1px solid black">
                                        <div class="card-body" id="card-ekskul">
