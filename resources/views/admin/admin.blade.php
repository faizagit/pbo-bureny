...
<head>
    ...
    <link href="{{ asset('../../assets_admin/plugins/perfectscroll/perfect-scrollbar.css') }}" rel="stylesheet" />
    <link href="{{ asset('../../assets_admin/plugins/apexcharts/apexcharts.css') }}" rel="stylesheet" />
        ...
        <div class="page-sidebar">
            <ul class="list-unstyled accordion-menu">
                ...
                <li class="{{ Route::current()->getName() == 'index_siswa' ? 'active-page' : '' }}">
                    <a href="{{ route('index_siswa') }}"><i data-feather="users"></i>Data User</a>
                </li>
                <li class="sidebar-title">Absen</li>
                <li class="{{ Route::current()->getName() == 'index_absen' ? 'active-page' : '' }}">
                    <a href="{{ route('index_absen') }}"><i data-feather="user-plus"></i>Absen Ekskul</a>
                </li>
